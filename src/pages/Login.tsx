...
export function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.message || 'Credenciais inválidas ou erro no servidor. Tente novamente.')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="auth-page">
      <div className="auth-card">
        ...
        <h2 className="auth-title">
          {isForgotPassword 
            ? 'Recuperar Senha'
            : isRegister ? 'Criar sua conta' : 'Entrar no sistema'}
        </h2>
        ...
        {isForgotPassword ? (
          <div style={{ textAlign: 'center', marginBottom: 20 }}>
            <p style={{ fontSize: 14, color: 'var(--text-muted)', lineHeight: '1.5', marginBottom: 16 }}>
              Para garantir a segurança dos seus dados, a recuperação de senha é feita manualmente pelo nosso suporte.
            </p>
            <p style={{ fontSize: 15, fontWeight: 500, color: '#fff', marginBottom: 16 }}>
              Envie um e-mail para:<br/>
              <span style={{ color: 'var(--brand)', fontSize: 18, fontWeight: 'bold' }}>contatosupplysistemas@gmail.com</span>
            </p>
            <p style={{ fontSize: 14, color: 'var(--text-muted)', lineHeight: '1.5' }}>
              Deixando claro qual é a sua <strong>Chave de Acesso</strong> (a mesma que foi informada no chat do Mercado Livre no momento da compra).
            </p>
            ...
            <>
              ...
              <div className="form-field">
                ...
                <input
                  ...
                  type="text"
                  className="key-input"
                  style={{ textTransform: 'uppercase', letterSpacing: '2px', textAlign: 'center', fontFamily: 'monospace' }}
                  value={activationKey}
                  onChange={(e) => {
                  ...
                  spellCheck={false}
                />
                <span className="key-hint" style={{ display: 'block', textAlign: 'right', fontSize: 12, marginTop: 4, color: 'var(--text-muted)' }}>
